...
const (
	...
	PluginPrefixPath               = "/v1/query/plugin-prefix"
	// debug
...
var routePaths = routes{
	...
	PluginPrefixName:                {Method: http.MethodGet, Path: PluginPrefixPath},
}
...
func createRouter(s *Server) *httprouter.Router {
	var r = httpRouteHandlers{
		...
		PluginPrefixName:               s.PluginPrefix,
	}
