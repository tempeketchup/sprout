...
// MessageCreatePost is a custom transaction to create a new social post
type MessageCreatePost struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	...
	ImageUrl       string                 `protobuf:"bytes,3,opt,name=image_url,json=imageUrl,proto3" json:"imageUrl"`        // @gotags: json:"imageUrl"
	PrizeTotal     uint64                 `protobuf:"varint,4,opt,name=prize_total,json=prizeTotal,proto3" json:"prizeTotal"` // @gotags: json:"prizeTotal"
	Deadline       uint64                 `protobuf:"varint,5,opt,name=deadline,proto3" json:"deadline,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *MessageCreatePost) Reset() {
	*x = MessageCreatePost{}
...
func (x *MessageCreatePost) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageCreatePost) ProtoMessage() {}

func (x *MessageCreatePost) ProtoReflect() protoreflect.Message {
	mi := &file_tx_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageCreatePost.ProtoReflect.Descriptor instead.
func (*MessageCreatePost) Descriptor() ([]byte, []int) {
	return file_tx_proto_rawDescGZIP(), []int{4}
}

func (x *MessageCreatePost) GetCreatorAddress() []byte {
	if x != nil {
...
func (x *MessageCreatePost) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
func (x *MessageCreatePost) GetImageUrl() string {
	if x != nil {
		return x.ImageUrl
	}
	return ""
...
func (x *MessageCreatePost) GetPrizeTotal() uint64 {
	if x != nil {
		return x.PrizeTotal
	}
	return 0
...
func (x *MessageCreatePost) GetDeadline() uint64 {
	if x != nil {
		return x.Deadline
	}
	return 0
...
const file_tx_proto_rawDesc = "" +
	...
	"\x11MessageCreatePost\x12'\n" +
	"\x0fcreator_address\x18\x01 \x01(\fR\x0ecreatorAddress\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\x12\x1b\n" +
	"\timage_url\x18\x03 \x01(\tR\bimageUrl\x12\x1f\n" +
	"\vprize_total\x18\x04 \x01(\x04R\n" +
	"prizeTotal\x12\x1a\n" +
	"\bdeadline\x18\x05 \x01(\x04R\bdeadlineB.Z,github.com/canopy-network/go-plugin/contractb\x06proto3"
...
var file_tx_proto_goTypes = []any{
	...
	(*MessageCreatePost)(nil), // 4: types.MessageCreatePost
	(*anypb.Any)(nil),         // 5: google.protobuf.Any
}
var file_tx_proto_depIdxs = []int32{
	5, // 0: types.Transaction.msg:type_name -> google.protobuf.Any
